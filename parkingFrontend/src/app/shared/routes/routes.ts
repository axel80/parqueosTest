export class routes {
  ...
  public static get registerVehicleType(): string {
    return this.baseUrl + '/vehicle-types/register';
  }
  public static get listVehicleType(): string {
    return this.baseUrl + '/vehicle-types/list';
  }
  public static get listVehicles(): string {
    return this.baseUrl + '/vehicles/list';
  }
  public static get addVehicles(): string {
    return this.baseUrl + '/vehicles/register';
  }
  public static get editVehicles(): string {
    return this.baseUrl + '/vehicles/edit';
  }
}
