      ...
      menu: [
        {
          ...
          subMenus: [
            {
              menuValue: 'Listado',
              route: routes.listVehicleType,
              base: routes.listVehicleType,
            },
...

        {
          ...
          subMenus: [
            {
              menuValue: 'List',
              route: routes.listVehicles,
              base: routes.listVehicles,
            },
            {
              menuValue: 'Register',
              route: routes.addVehicles,
              base: routes.addVehicles,
            },

          ],
        },
        {
          menuValue: 'Transacciones',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'gallery',
          base2: 'profile',
